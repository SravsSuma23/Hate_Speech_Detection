...
TRAIN_PCA = f"{BASE_PATH}/pca_features_lstm_train"
DEV_PCA   = f"{BASE_PATH}/pca_features_lstm_dev"
TEST_PCA  = f"{BASE_PATH}/pca_features_lstm_test"

OUTPUT_BALANCED = f"{BASE_PATH}/balanced_train_lstm_pca"

# ==================== SPARK SESSION ====================
spark = SparkSession.builder \
    .appName("SMOTE on LSTM PCA Features") \
...
print("\n📥 Loading training PCA features (LSTM pipeline)...")
