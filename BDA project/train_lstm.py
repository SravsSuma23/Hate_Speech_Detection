...
# Paths for LSTM pipeline
TRAIN_BALANCED = f"{BASE_PATH}/balanced_train_lstm_pca"
DEV_PATH       = f"{BASE_PATH}/pca_features_lstm_dev"
TEST_PATH      = f"{BASE_PATH}/pca_features_lstm_test"
PREDICTIONS_OUTPUT = f"{BASE_PATH}/test_predictions_lstm"
...
# ==================== LOAD DATA ====================
print("\n📥 Loading balanced training data (LSTM)...")
...
best_dev_acc = 0.0
best_model_path = "/tmp/best_model_lstm.pt"
